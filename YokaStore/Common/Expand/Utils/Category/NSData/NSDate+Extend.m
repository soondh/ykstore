 ...
 *  是否大于三天小于十天
 */
-(BOOL)isMoreThanThreeSmallerThenTen
{
    return [self calWithValueOne:3 ValueTwo:10];
}

-(BOOL)calWithValueOne:(NSInteger)value ValueTwo:(NSInteger)valueTwo
{
    ...
    //比较
    BOOL res=dateComponents.year==nowComponents.year && dateComponents.month==nowComponents.month && (dateComponents.day + value)<=nowComponents.day && (dateComponents.day + valueTwo)>=nowComponents.day;
