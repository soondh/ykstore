...
+ (UIImage *) resizeImage:(UIImage *) image withNewSize:(CGSize) newSize{
    ...
    UIGraphicsBeginImageContext(CGSizeMake( floor(newSize.width), floor(newSize.height)));
    [image drawInRect:CGRectMake(0, 0, floor(newSize.width), floor(newSize.height))];
