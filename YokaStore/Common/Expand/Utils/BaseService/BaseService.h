 ...
 *  @param error     错误描述
 */
typedef void(^ResultBlock)(NSInteger stateCode, id result, NSError *error);
 ...
 *  @param requestBlock 请求回调
 */
+(void)POSTVideoWithFormDataURL:(NSString *)URLString parameters:(id)parameters mediaData:(NSMutableArray *)mediaDatas completionBlock:(ResultBlock)requestBlock;
