...
#define appNavigatioånBarHeight  self.navigationController.frame.size.height

#define app_top_height      (kDevice_Is_iPhoneX ? 88 : 64)
#define app_bottom_height   (kDevice_Is_iPhoneX ? 83 : 49)
